...
```
.
├── Replication Directory    # create this
    ├── data #create this 
    ...
    |   ├── Random_forest.py                      # Random Forest model code (full sample)
    ...
    ├── output                           # txt/pdf files generated from above .py and .R files may be stored in this folder
        ...
        ├── table3.pdf                   # Table 3: Random Fores model extension 
...
4. Run the .R file. I reccomend running this file in RStudio making sure that in this IDE your working directory is set to "data" (or whichever folder contains the files shown above). You may need to install specific packages first if you are new to RStudio. THis can be done with the syntax install.packages("package").
5. The .pdf files of the figures/tables will be saved in the parent directory once you have ran the .R file. This concludes the replication of the original paper as well as my extension.
